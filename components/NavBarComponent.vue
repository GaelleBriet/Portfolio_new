...
<template>
  <div class="flex justify-center items-end h-full">
    <div
      class="w-[358px] h-[60px] flex flex-row items-center justify-center nav-light dark:nav-dark"
    >
      <template v-for="navItem in navItems" :key="navItem.name">
        <NuxtLink
          ...
          :class="[
            'relative  h-10 w-[54px] flex items-center justify-center rounded-xl transition-all duration-300',
